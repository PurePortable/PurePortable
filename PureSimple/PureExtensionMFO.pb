...
Procedure ExtensionProcedure()
	...
	MHX_HookApi(kernel32,FindFirstFileW)
	MHX_HookApi(kernel32,FindFirstFileExA)
	MHX_HookApi(kernel32,FindFirstFileExW)
	MHX_HookApi(kernel32,GetFileAttributesA)
	MHX_HookApi(kernel32,GetFileAttributesW)
	MHX_HookApi(kernel32,GetFileAttributesExA)
	MHX_HookApi(kernel32,GetFileAttributesExW)
	MHX_HookApi(kernel32,CreateFile2,#MH_HOOKAPI_NOCHECKRESULT)
	MHX_HookApi(kernel32,CreateFileA)
	MHX_HookApi(kernel32,CreateFileW)
	MHX_HookApi(kernel32,CreateDirectoryA)
	MHX_HookApi(kernel32,CreateDirectoryW)
	MHX_HookApi(kernel32,CreateDirectoryExA)
	MHX_HookApi(kernel32,CreateDirectoryExW)
	LoadLibrary_(@"shell32.dll")
	MHX_HookApi(shell32,SHCreateDirectoryExA)
	MHX_HookApi(shell32,SHCreateDirectoryExW)
	MHX_HookApi(shell32,SHFileOperationA)
	MHX_HookApi(shell32,SHFileOperationW)
EndProcedure
;;======================================================================================================================
