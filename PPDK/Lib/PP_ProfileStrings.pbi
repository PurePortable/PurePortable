...
CompilerIf Not Defined(DETOUR_PRIVATEPROFILESTRING,#PB_Constant) : #DETOUR_PRIVATEPROFILESTRING = 1 : CompilerEndIf
CompilerIf Not Defined(DETOUR_PROFILESTRING,#PB_Constant) : #DETOUR_PROFILESTRING = 1 : CompilerEndIf
...
;;----------------------------------------------------------------------------------------------------------------------
CompilerIf #DETOUR_PRIVATEPROFILESTRING
...
CompilerEndIf
;;----------------------------------------------------------------------------------------------------------------------
CompilerIf #DETOUR_PROFILESTRING
